...
/**
 * TypeScript Script: Initialize Pool A-Native SOL (Fixed)
 * This creates a pool between Token A and native SOL using the correct account setup
 */
async function initPoolANativeSOLFixed() {
  try {
    console.log("🚀 TypeScript Script: Initializing Pool A-Native SOL (Fixed)...");
...
// Run the function
initPoolANativeSOLFixed().catch(console.error);
